...
export const generateDiagnosisReport = (
    ...
    <head>
        <meta charset="UTF-8">
        <title>Crop Doctor - Diagnosis Report</title>
        <style>
    ...
    <body>
        <div class="watermark">CROP DOCTOR</div>
        <div class="header">
        ...
        <div class="footer">
            <p>This report is generated by AI (Crop Doctor). For critical decisions, please consult an agricultural expert.</p>
            <p>&copy; 2026 Crop Doctor | Agri Tech Hackathon</p>
        </div>
